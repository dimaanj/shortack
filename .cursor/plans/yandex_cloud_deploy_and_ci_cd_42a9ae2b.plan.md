...
- Добавить в репозиторий один конфиг или документ с итоговой матрицей решений (например `shortack/docs/deployment-choices.md` или секция в существующей документации). В плане можно ссылаться: «см. deployment-choices.md».
